...
#####################
##### these functions define the cognitive architecture by adding specific functionality for use in productions
#####################


## this function is for retrieving from Declarative Memory (DM)
## it requiers this structure in WM
        
##working_memory = {
##    'goalbuffer': {'process': 'DMretrieve', 'animal': 'cat', 'colour': 'brown'}, 
##    'DMbuffer': {}
##}

## it will take everything after 'process': 'DMretrieve' as a cue
...
def action_test_ProductionSystem1(working_memory):
    # Create an instance of DMHandler to search DM
    dm_handler = DMHandler(DM)
    # Use DMHandler to update the DMbuffer with results of search
    dm_handler.update_dm_buffer(working_memory)
    return 0
PS1_list.append({
    'matches': {'goalbuffer': {'process': 'DMretrieve', 'animal': 'cat', 'colour': 'brown'}},
    'negations': {},
    'utility': 10,
